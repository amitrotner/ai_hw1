    ...
    def solve_problem(self, problem: GraphProblem) -> SearchResult:
        with Timer(print_title=False) as timer:
            ...
            while (high_heuristic_weight - low_heuristic_weight) > 0.01:
                ...
                mid = (high_heuristic_weight + low_heuristic_weight) / 2
                ast = AStar(self.heuristic_function_type, mid, self.max_nr_states_to_expand_per_iteration)
                ...
                if res.is_solution_found:
                    ...
                    if best_solution.solution_g_cost > res.solution_g_cost:
                        best_solution = res
